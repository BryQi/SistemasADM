...
public class AutorizacionesResource {
    ...
    public ResponseEntity<List<AutorizacionesDTO>> getAllAutorizaciones(@org.springdoc.api.annotations.ParameterObject Pageable pageable) {
        log.debug("REST request to get a page of Autorizaciones");
        Page<AutorizacionesDTO> page = autorizacionesService.findAll(pageable);

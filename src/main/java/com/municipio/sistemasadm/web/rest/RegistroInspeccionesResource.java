...
public class RegistroInspeccionesResource {
    ...
    public ResponseEntity<List<RegistroInspeccionesDTO>> getAllRegistroInspecciones(
        ...
        Page<RegistroInspeccionesDTO> page;
        if (eagerload) {
            page = registroInspeccionesService.findAllWithEagerRelationships(pageable);
        } else {
            page = registroInspeccionesService.findAll(pageable);
        }

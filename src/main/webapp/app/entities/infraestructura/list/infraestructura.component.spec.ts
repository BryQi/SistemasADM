...
describe('Infraestructura Management Component', () => {
  let comp: InfraestructuraComponent;
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [
        RouterTestingModule.withRoutes([{ path: 'infraestructura', component: InfraestructuraComponent }]),
      ...
      .overrideTemplate(InfraestructuraComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.infraestructuras?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });

  describe('trackId', () => {
    it('Should forward to infraestructuraService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getInfraestructuraIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getInfraestructuraIdentifier).toHaveBeenCalledWith(entity);
